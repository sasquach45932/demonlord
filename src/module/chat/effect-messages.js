...
export function buildAttackEffectsMessage(attacker, defender, item, attackAttribute, defenseAttribute, inputBoons, plus20, inputModifier) {
  ...
  const horrifyingText = applyHorrifyingBane > 1 ? game.i18n.localize('DL.CaneSeeSoureOfAffliction') : `${game.i18n.localize(creatureType)} [${game.i18n.localize('DL.ActionTarget')}]`
